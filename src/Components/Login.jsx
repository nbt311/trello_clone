        ...
        return (
            <section className="relative bg-gray-100 h-screen">
                <div className="flex flex-col  items-center justify-center h-screen">
                    <div className="w-full bg-white rounded-lg md:mt-0 sm:max-w-md xl:p-0 space-y-10">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="">
                                        <div className={`items-start ${
                                            ...
                                            <label htmlFor="email"
                                                   className="text-sm font-medium text-gray-900 dark:text-white block text-left ml-6 ">Your
                                                email</label>
                                            <input type="text" name="email" id="email" value={form.email || ""}
                                                   onChange={handleChange}
                                                   className="hover:bg-gray-200 bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600  w-[90%] p-2.5"
