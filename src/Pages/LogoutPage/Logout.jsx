        ...
        <div>
            <section className="relative bg-gray-100 h-screen">
                <div className="flex flex-col  items-center justify-center h-screen">
                    <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 space-y-10">
                        ...
                        <a href="#" className="block font-medium md:text-sm text-blue-400  hover:underline dark:text-primary-500">Sign in to another account</a>
                    </div>
                </div>
